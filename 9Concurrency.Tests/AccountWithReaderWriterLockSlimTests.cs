...
{
    public class AccountWithReaderWriterLockSlimTests
    {
        [Fact]
        public void Test_Concurrent_Deposit_And_Withdraw()
        {
            ...
            var account = new AccountWithReaderWriterLockSlim(1234, "Magnus", "Carlsen", initialBalance);
        ...
        public async Task WhenMultipleWithdrawsOccurAtTheSameTime_The_UserBalance_Get_Corrupted()
        {
            ...
            var account = new AccountWithReaderWriterLockSlim(1000, "Magnus", "Carlsen", initialBalance);
